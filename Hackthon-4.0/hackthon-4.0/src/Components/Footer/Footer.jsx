        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              <img src="file-6JcaQAPzYXvw9RwLXzkjGv (1).jpg" className="h-10 w-10 rounded-lg shadow-lg" alt="The Errors Logo" />
              <span className="text-2xl font-bold">The Errors</span>
            </div>
            <p className="text-gray-400">Innovating the future, one line of code at a time.</p>
          </div>

          {/* Quick Links */}
          <div className="text-center">
            <div className="flex justify-center gap-8">
              <a href="#" className="hover:text-gray-400 transition-colors duration-300 flex items-center gap-2">
                <span>About</span>
              </a>
              <a href="#" className="hover:text-gray-400 transition-colors duration-300 flex items-center gap-2">
                <span>Services</span>
